        ...
        <Container maxWidth="lg" sx={{ mt: 6, mb: 8 }}>
          ...
          <Box sx={{ mb: 8, textAlign: 'center', px: { xs: 2, md: 10 } }}>
            ...
            <Typography variant="body1" paragraph color="text.secondary">
              At Aya's Lash studio, we believe in creating a tranquil environment where you can escape the stresses of everyday life. 
              We are dedicated to providing exceptional service tailored to your individual vision.
            </Typography>
            <Typography variant="body1" color="text.secondary">
              Using only premium products and unique techniques, we ensure that you leave our studio feeling refreshed and confident.
            </Typography>
          </Box>
