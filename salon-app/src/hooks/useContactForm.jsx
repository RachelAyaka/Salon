...
function useContactForm(){
    const [updateContactFormSuccessful, setUpdateContactFormSuccessful] = useState(false)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
        const response =  await axiosInstance.post('/contact', { name: name, email: email, phone: phone, message: message })
